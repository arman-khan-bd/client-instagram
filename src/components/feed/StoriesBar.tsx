    ...
    <div className="bg-[#111] border border-[#222] rounded-2xl p-4.5 mb-5 select-none w-full">
      <div className="flex gap-4 overflow-x-auto no-scrollbar pb-1">
          ...
          <div className="relative">
            {hasMyStory ? (
              <div
                ...
                className="w-[60px] h-[60px] rounded-full p-[2px] bg-[linear-gradient(45deg,#f09433_0%,#e6683c_25%,#dc2743_50%,#cc2366_75%,#bc1888_100%)] cursor-pointer"
              >
                <img
        ...
        {storyGroups.map((group, idx) => {
          // Skip if it's the current user's story (already handled first)
